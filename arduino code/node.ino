...
#define FIREBASE_HOST "arduino-c6006-default-rtdb.firebaseio.com"                          // the project name address from firebase id
#define FIREBASE_AUTH "AIzaSyD67FaZwFUEn1J9wnVNFG4Z1RPPdUE6PLY"            // the secret key generated from firebase
...
const char *ssid = "okay";  //ENTER YOUR WIFI SETTINGS
const char *password = "leonsh416";
const char apiUrl[110] = "http://api.weatherbit.io/v2.0/forecast/agweather?lat=19.105&lon=73.007&key=d46e4428e10d46daa7f0e93f72dcaca7";
...
const char fingerprint[] PROGMEM = "04 E0 BD B0 F8 63 22 3C 3A 19 7D 92 B6 79 2A 44 BF 77 FC DA";
// //=======================================================================
//                    Power on setup
//=======================================================================
...
httpAgro.begin(wifiClient,"http://api.weatherbit.io/v2.0/forecast/agweather?lat=19.10556&lon=73.007&key=915f8b429f6644b384bab94c5211609b");//("http://api.weatherbit.io/v2.0/current?lat=19.10556&lon=73.007&key=10fe4d3c09b64cb18e44c87dd9003578");  //Specify request destination
...
http.begin(wifiClient,"http://api.openweathermap.org/data/2.5/weather?lat=19.10556&lon=73.007&appid=8f9bc27b855db221dae3a2aa4880ce73");//Specify request destination
...
DynamicJsonBuffer jsonBufferO(782);
 ...
 openW.toCharArray(jsonO, openW.length() + 1);
  ...
  temp_min = (rootO["main"]["temp_min"]);
  tempMax = (rootO["main"]["temp_max"]);
  temp_min = temp_min - 273;
  tempMax = tempMax - 273;


  Firebase.pushFloat("/datatemp_min",temp_min);
  Firebase.pushFloat("/dataTempMax",tempMax);
  Firebase.setFloat("/Displaytemp_min",temp_min);
...
httpWeatherBit.begin(wifiClient,"http://api.weatherbit.io/v2.0/current?lat=19.10556&lon=73.007&key=915f8b429f6644b384bab94c5211609b");  //Specify request destination
...
float tempMean = (temp_min+tempMax)/2;
...
float p2 = (17.27*temp_min)/(temp_min+273.3);
