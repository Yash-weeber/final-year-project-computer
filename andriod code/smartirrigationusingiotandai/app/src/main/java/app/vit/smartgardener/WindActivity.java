    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        db.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                String temperature = dataSnapshot.child("DisplayWindSpeed").getValue().toString();
                precip.setText(temperature.substring(0,3)+"m/s");

                String hum = dataSnapshot.child("DisplayPressure").getValue().toString();
                humTV.setText(hum+"hPa");
            ...
            public void onCancelled(@NonNull DatabaseError databaseError) {
                precipPB.setVisibility(View.GONE);
                humPB.setVisibility(View.GONE);
                new AlertDialog.Builder(WindActivity.this)
                        .setTitle("Oops!")
